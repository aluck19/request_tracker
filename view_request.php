...
<div class="ui form" style="margin-top: 10px">
	<div class="field">
		...
		<p><?php echo ucfirst($request -> department); ?></p>
...
<div class="ui form">
  <h4>New Comment</h4>
      ...
      <div class="input-group date form_datetime" data-date-format="dd MM yyyy  HH:ii p" data-link-field="dtp_input1">
					...
					<span style=" position: relative;  left: -3px;  z-index: 999;" class="input-group-addon"><span class="glyphicon glyphicon-remove"></span></span>
